...
def proxy_login():
    ...
    if response.status_code == 200:
        ...
        try:
            payload = jwt.decode(tokens.get("access_token"), JWT_SECRET, algorithms=["HS256"])
...
def proxy_refresh():
    ...
    response = proxy_request("POST", "/api/v1/auth/refresh", json={"refresh_token": refresh_token})
