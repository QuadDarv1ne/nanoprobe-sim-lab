...
def upgrade():
    ...
    op.create_index(
        "idx_scan_surface_date", "scan_results", ["surface_type", "created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_simulations_status_created", "simulations", ["status", "created_at"], unique=False
    )
    ...
    op.create_index(
        "idx_batch_jobs_status_created", "batch_jobs", ["status", "created_at"], unique=False
    )
