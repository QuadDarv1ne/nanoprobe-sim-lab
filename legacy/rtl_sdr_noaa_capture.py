...
def main():
    ...
    parser.add_argument('--sat', '--satellite', type=str, default='noaa19',
                        choices=['noaa15', 'noaa18', 'noaa19'],
                        help='Спутник (default: noaa19)')
    parser.add_argument('-f', '--frequency', type=float, default=None,
                        help='Частота MHz (переопределяет --sat)')
    parser.add_argument('-g', '--gain', type=float, default=30.0,
                        help='Усиление dB (default: 30)')
