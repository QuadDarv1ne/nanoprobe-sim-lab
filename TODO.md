...
**Последнее обновление:** 2026-04-11 16:00

## Статус проекта

- **Ветка:** `dev` (активная разработка) → `main` (стабильная)
- **Рабочее дерево:** чистое ✅
- **Последний коммит:** синхронизирован с origin/dev
- **Python:** 3.11 - 3.14
...
2. [ ] Проверять тесты после изменений
3. [ ] Merge в `main` только после стабилизации
4. [ ] Синхронизировать изменения с origin

### MEDIUM
5. [ ] Увеличить test coverage до 80%+
6. [ ] Настроить bias_tee для активной антенны
7. [ ] Откалибровать TCXO (--freq-correction)
8. [ ] Дождаться пролёта МКС для SSTV записи

### LOW
9. [ ] Исправить оставшиеся ~197 E501 строк (HTML/CSS, SQL, config dicts)
10. [ ] Мигрировать frontend на Next.js (убрать Flask)
11. [ ] Решить SQLite vs PostgreSQL (есть guide в docs/)
12. [ ] Создать mobile application
13. [ ] Добавить external integrations (NASA, Zenodo, Figshare)
