...
**Последнее обновление:** 2026-04-11 17:30

## Статус проекта

- **Ветка:** `dev` (активная разработка) → `main` (стабильная)
- **Рабочее дерево:** чистое ✅
- **Коммиты в dev:** 5 ahead of origin/dev (ожидает push)
- **Python:** 3.11 - 3.14
...
4. [ ] Синхронизировать изменения с origin (push pending)

### MEDIUM
5. [ ] Увеличить test coverage до 80%+
6. [ ] Разбить api/routes/dashboard.py на модули (41 КБ)
7. [ ] Разбить api/routes/auth.py на модули (30 КБ)
