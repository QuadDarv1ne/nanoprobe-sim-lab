...
def test_rotating_file_handler():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"✓ Ротация файлов: PASS (создано файлов: {len(log_files)})")
        return True
...
def test_context_logging():
    ...
    try:
        ...
        print("✓ Контекстное логирование: PASS")
        return True
    finally:
...
def test_multiple_loggers():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print("✓ Множественные логгеры: PASS")
        return True
