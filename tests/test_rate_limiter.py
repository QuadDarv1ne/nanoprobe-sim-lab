...
def test_rate_limiter_basic():
    ...
    print("✓ Базовый rate limiting: PASS")
...
def test_progressive_blocking():
    ...
    print("✓ Прогрессивная блокировка: PASS")
...
def test_cleanup_old_entries():
    ...
    print("✓ Очистка старых записей: PASS")
