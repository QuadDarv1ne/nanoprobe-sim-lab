...
class TestNasaRoutes:
    ...
    def test_apod_success(self, mock_get_client, client):
        ...
        mock_client = Mock()
        mock_client.get_apod = AsyncMock(return_value={
            "title": "Test APOD",
    ...
    def test_mars_photos_success(self, mock_get_client, client):
        ...
        mock_client = Mock()
        mock_client.get_mars_photos = AsyncMock(return_value={
            "photos": [
    ...
    def test_asteroids_feed(self, mock_get_client, client):
        ...
        mock_client = Mock()
        mock_client.get_asteroids = AsyncMock(return_value={
...
class TestWeatherRoutes:
    ...
    def test_weather_historical(self, mock_fetch, client):
        ...
        response = client.get(
            "/api/v1/weather/historical?lat=55.7558&lon=37.6173&date=2026-04-01"
        )
...
class TestIntegrationExternalServices:
    ...
    def test_multiple_external_services(self, mock_weather, mock_nasa, client):
        ...
        weather_response = client.get(
            "/api/v1/weather/current?lat=55.7&lon=37.6"
        )
