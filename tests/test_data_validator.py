...
class TestDataValidator(unittest.TestCase):
    ...
    def test_validation_result(self):
        ...
        result = ValidationResult(
            is_valid=True, errors=[], warnings=[], suggestions=[], metadata={"test": "data"}
        )
    ...
    def test_validate_dataframe_range_check(self):
        ...
        schema = {
            "value": {"dtype": "float", "required": True, "range": (0, 20)},
        }
        result = self.validator.validate_dataframe(self.sample_df, schema)
    ...
    def test_add_validation_rule(self):
        ...
        self.validator.add_validation_rule(
            "positive_field", custom_validator, error_message="Значение должно быть положительным"
        )
