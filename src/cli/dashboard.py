...
Этот модуль предоставляет графический интерфейс для управления
всеми компонентами проекта.
"""
...
class NanoprobeDashboard:
    """
    Интерактивная панель управления проектом.

    Предоставляет графический интерфейс для управления всеми компонентами
    ...
    def update_status_info(self):
        ...
        status_info = (
            ...
            f"- Анализатор изображений: "
            f"{'Инициализирован' if self.orchestrator.image_processor else 'Не инициализирован'}\n"
            f"- SSTV декодер: "
            f"{'Инициализирован' if self.orchestrator.sstv_decoder else 'Не инициализирован'}\n\n"
            "ПУТИ:\n"
            f"- Данные: {self.data_manager.data_dir}\n"
            f"- Вывод: {self.data_manager.output_dir}\n"
        )
